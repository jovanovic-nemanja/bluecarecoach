...
class CreateUseractivityReportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('useractivity_reports', function (Blueprint $table) {
            $table->increments('id');

            $table->integer('assign_id')->unsigned();
            $table->foreign('assign_id')->references('id')->on('user_activities');
    ...
    {
        Schema::dropIfExists('useractivity_reports');
    }
}
