            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Add Email Template Setting</h2>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                    ...
                    <div class="card-body">
                        <form action="{{ route('emailsettings.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <select class="form-control type_emailsettings" name='type' required>
                                        ...
                                        <option value='3'>Looking For Job Status</option>
                                        <option value='4'>Expiry Reminder Cronjob</option>
                                        <option value='5'>Expiry Reminder Schedule less 31days</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('from_address') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="email" class="form-control" name='from_address' placeholder="From Address" value="{{ old('from_address') }}" required>
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('from_title') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name='from_title' placeholder="From Title" value="{{ old('from_title') }}" required>
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name='subject' placeholder="From Title" value="{{ old('subject') }}" required>
                                </div>
                            ...
                            <div class="form-group {{ $errors->has('content_name') ? 'has-error' : '' }} content_name">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name='content_name' placeholder="Content Header" value="{{ old('content_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('content_body') ? 'has-error' : '' }} content_body">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name='content_body' placeholder="Content Body" value="{{ old('content_body') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('pre_footer') ? 'has-error' : '' }} pre_footer">
                                ...
                                <div class="controls">
                                    <textarea class="form-control" name='pre_footer' placeholder="Pre footer" rows="8"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('footer') ? 'has-error' : '' }} footer">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name='footer' placeholder="Footer" value="{{ old('footer') }}">
                                </div>
                            </div>
