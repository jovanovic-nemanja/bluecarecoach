...
class UsersController extends Controller
{
    ...
    public function getvideolink(Request $request)
    {
        ...
        $now = getdate();
        $expired_credentials = Credentialusers::where('userid', $request->userid)->whereDate('expire_date', '<', Carbon::now())->get();
